...
function loadNavbar() {
    ...
    if ( ! localStorage['username'] ) {
        ...
        navbarButton = `<button type="button" onClick="window.location.href='` + HOST_URL + `profile/` + localStorage['username'] + ` '" class="loginButton"> Profile </button>`;
    }


    document.getElementById("navigationBar")
        .innerHTML = `<a href="` + HOST_URL + `" class="homeButton">
        <svg id="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100" height="100">
    ...
    <nav class="navBar">
        ...
        <label for="checkNav" class="dropNav">
